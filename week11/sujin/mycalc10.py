...
class Calculator(QWidget):
    ...
    def buttonClicked(self):
        ...
        if key in constantList:
            self.display.clear()
            self.display.setText(operatorFunctions.constantOperator(key))
        elif key in functionList:
            self.display.setText(operatorFunctions.functionOperator(key, display))
        elif key in numPadList or operatorList:
            self.display.setText(operatorFunctions.numPadOperator(key, display))
